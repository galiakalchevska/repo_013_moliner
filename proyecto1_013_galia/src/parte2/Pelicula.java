...
import parte1.Almacen;

enum Formato {
	WAV, MP3, MIDI, AVI, PNG, JPG
};
...
public class Pelicula extends Almacen {
	...
	/*
	 * Otra manera de definir el constructor,sin usar método para comprobar, o
	 * sea directamente
	 */

	/*
	 * public Pelicula (String actor_principal, String actriz_principal){
	 * if(actor_principal == null && actriz_principal == null){ throw new
	 * IllegalArgumentException("Tiene que haber al menos un protagonista"); }
	 * this.actor_principal = actor_principal; this.actriz_principal =
	 * actriz_principal; }
	 */
	 ...
	 * @param cantidad_de_copias
	 */
	public Pelicula(String titulo, String autor, parte1.Formato formato,
	...
	public void comprobar(String actor_principal, String actriz_principal) {
		...
		if (this.actor_principal == null) {
			/*
			 * estoy usando un método de la clase Object, por lo que he leído es
			 * parte de los grandes desconocidos ,pero en casos como este nos es
			 * de gran utilidad, al comparar si un objeto es nulo.
			 * 
			 * Los enlaces donde lo he visto:
			 * https://simonharrer.wordpress.com/2012
			 * /02/28/objects-a-not-very-well-known-utility-class-in-java/
			 * http://docs.oracle.com/javase/7/docs/api/java/util/Objects.html
			 * 
			 * Imprime el mensaje definido en caso de que ambos atributos son
			 * nulos.
			 */
	...
	/*
	 * public String toString() { return super.toString() + "Identificador: " +
	 * this.idPelicula + "\nCantidad de copias: " + this.cantidad_de_copias +
	 * "\nActor principal: " + this.actor_principal + "\nActriz principal: " +
	 * this.actriz_principal; }
	 */

	/* Otra manera de escribir el toString */
	...
	public String toString() {
		...
		return informacion + super.toString();
	}
}
